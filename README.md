...
| chef_resources.json | Chef Infra Recipe Resources (Ruby Format) | [**Autogenerated using Rakefile**](#autogenerated-snippet-updates) |
| chef_yaml_resources.json | Chef Infra Recipe Resources (YAML Format) | [**Autogenerated using Rakefile**](#autogenerated-snippet-updates) |
